...
typedef enum {PA0, PA1, PA2, PA3, PA4, PA5, PA6, PA7,
			  ...
			  PD0, PD1, PD2, PD3, PD4, PD5, PD6, PD7,FAILED_CASE_PIN} enuDIOPinNo_t;
typedef enum {INPUT, OUTPUT,FAILED_CASE_DIR} enuDIOPinDir_t;
typedef enum {NO_CONNECTION, PULL_UP_ENABLE,FAILED_CASE_RES} enuDIOPullupResEn_t;
