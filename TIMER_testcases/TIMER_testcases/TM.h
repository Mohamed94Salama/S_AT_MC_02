...
typedef enum {TIMER0, TIMER1, TIMER2,FAILED_CASE_TIMER} enuTimerModule_t;
typedef enum {NORMAL, CTC, FAST_PWM, PC_PWM,FAILED_CASE_MODE} enuTimerMode_t;
typedef enum {NO_CLOCK, NO_PRESCALER, PRESCALER_8, PRESCALER_64, PRESCALER_256, PRESCALER_1024, 
			  EXTERNAL_CLOCK_FALL_EDGE, EXTERNAL_CLOCK_RISE_EDGE, PRESCALER_32, PRESCALER_128,FAILED_CASE_PRESCALER} enuTimerClock_t;
typedef enum {TIMER_INT_DIS, TIMER_INT_EN, FAILED_CASE_INT} enuTimerIntEn_t;
typedef enum {OC0_Disconnected, Toggle_OC0, Clear_OC0, Set_OC0,FAILED_CASE_OC0}enuCTCModeTimer0_t;
typedef enum {OC1_Disconnected, Toggle_OC1, Clear_OC1, Set_OC1,FAILED_CASE_OC1}enuCTCModeTimer1_t;
typedef enum {OC2_Disconnected, Toggle_OC2, Clear_OC2, Set_OC2,FAILED_CASE_OC2}enuCTCModeTimer2_t;
